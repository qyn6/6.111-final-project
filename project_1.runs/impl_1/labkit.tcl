...
set rc [catch {
  ...
  set_property ip_repo_paths /afs/athena.mit.edu/user/q/y/qyn/Desktop/6.111/final_project/project_1.cache/ip [current_project]
  set_property ip_output_repo /afs/athena.mit.edu/user/q/y/qyn/Desktop/6.111/final_project/project_1.cache/ip [current_project]
  add_files -quiet /afs/athena.mit.edu/user/q/y/qyn/Desktop/6.111/final_project/project_1.runs/synth_1/labkit.dcp
  ...
  set_property netlist_only true [get_files /afs/athena.mit.edu/user/q/y/qyn/Desktop/6.111/final_project/project_1.runs/video_bram_synth_1/video_bram.dcp]
  read_xdc -mode out_of_context -ref video_bram -cells U0 /afs/athena.mit.edu/user/q/y/qyn/Desktop/6.111/final_project/project_1.srcs/sources_1/ip/video_bram/video_bram_ooc.xdc
  set_property processing_order EARLY [get_files /afs/athena.mit.edu/user/q/y/qyn/Desktop/6.111/final_project/project_1.srcs/sources_1/ip/video_bram/video_bram_ooc.xdc]
...
set rc [catch {
  ...
  if { [file exists /afs/athena.mit.edu/user/q/y/qyn/Desktop/6.111/final_project/project_1.runs/synth_1/labkit.hwdef] } {
    catch { write_sysdef -hwdef /afs/athena.mit.edu/user/q/y/qyn/Desktop/6.111/final_project/project_1.runs/synth_1/labkit.hwdef -bitfile labkit.bit -meminfo labkit.mmi -file labkit.sysdef }
  }
